...
$(function() {
    ...
    function containerHeight() {
        ...
        if ($('.chat-list').length){
            var availableHeightchat = availableHeight-$('#container-1 .nav-tabs').outerHeight()-$('#container-1 .nav-tabs .tab-content > form').outerHeight()-222;
            if (availableHeightchat > 60) {
                $('.chat-list').each(function() {
                    $(this).height(availableHeightchat);
                });
            }
        }
    }
