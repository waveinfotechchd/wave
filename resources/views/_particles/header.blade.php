  ...
  <div class="navbar-collapse collapse" id="navbar-mobile">
    <ul class="nav navbar-nav navbar-right">
      ...
      <li class="dropdown dropdown-user"> <a class="dropdown-toggle" data-toggle="dropdown">                                        
          <?php if(isset(Auth::user()->image_icon)){ ?><img  src="{{ URL::asset('upload/members/'.Auth::user()->image_icon) }}" alt=""><?php }else{ ?> <img  src="{{ URL::asset('site_assets/images/placeholder.jpg') }}" alt=""><?php } ?>
