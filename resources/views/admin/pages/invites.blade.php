...
<script type="text/javascript">
  ...
  function invitesfilter(keys,types){
   ...
   var dt1=$('#date').text(); 
   alert(dt+' '+dt1);
  $.get('./invitefilters',{key:keys,type:types}, function (data){
    if(data){  
       // alert(data);
        $('#loaded_user').html(''); 
...
function invitesfilter2(){
   ...
   var dt=$('#datepicker').text(); 
   var types='sendafter'
  $.get('./invitefilters',{key:dt,type:types}, function (data){
    if(data){  
                    ...
                    <div class="col-md-12">
                        <div class="panel panel-flat">
                            <div class="panel-heading">
                                <h6 class="panel-title" style="font-size: 18px;    text-align: -webkit-left;">Invites
                                </h6>
